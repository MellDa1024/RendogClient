...
import kr.rendog.client.util.graphics.ESPRenderer
import kr.rendog.client.util.graphics.GeometryMasks
...
object SelectionHighlight : Module(
    ...
    init {
        safeListener<RenderWorldEvent> {
            ...
            val eyePos = viewEntity.getPositionEyes(RendogTessellator.pTicks())
