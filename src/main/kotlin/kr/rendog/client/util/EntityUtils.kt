...
import kr.rendog.client.commons.extension.ceilToInt
import kr.rendog.client.commons.extension.floorToInt
import kr.rendog.client.event.SafeClientEvent
import kr.rendog.client.util.MovementUtils.calcMoveYaw
import kr.rendog.client.util.items.id
...
object EntityUtils {
    ...
    fun playerTypeCheck(player: EntityPlayer, friend: Boolean, sleeping: Boolean) = sleeping || !player.isPlayerSleeping
