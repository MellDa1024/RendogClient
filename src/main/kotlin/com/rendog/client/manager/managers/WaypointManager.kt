...
import com.rendog.client.event.listener.events.WaypointUpdateEvent
import com.rendog.client.manager.Manager
import com.rendog.client.util.ConfigUtils
import com.rendog.client.util.Wrapper
import com.rendog.client.util.math.CoordinateConverter
import com.rendog.client.util.math.CoordinateConverter.asString
...
object WaypointManager : Manager {
    ...
    private val file = File(RendogMod.DIRECTORY + "waypoints.json")
