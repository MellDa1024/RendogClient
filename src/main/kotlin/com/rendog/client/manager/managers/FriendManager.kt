...
object FriendManager : Manager {
    ...
    private val file = File(RendogMod.DIRECTORY + "friends.json")
    ...
    fun loadFriends(): Boolean {
        ...
        return try {
            ...
            RendogMod.LOG.info("Friend loaded")
            true
        } catch (e: Exception) {
            RendogMod.LOG.warn("Failed loading friends", e)
            false
        }
    }
    ...
    fun saveFriends(): Boolean {
        return try {
            ...
            RendogMod.LOG.info("Friends saved")
            true
        } catch (e: Exception) {
            RendogMod.LOG.warn("Failed saving friends", e)
            false
        }
    }
