...
import com.rendog.client.setting.groups.SettingGroup
import com.rendog.client.setting.groups.SettingMultiGroup
...
abstract class AbstractConfig<T : Any>(
    ...
    override fun load() {
        try {
            ...
            RendogMod.LOG.warn("Failed to load latest, loading backup.")
