...
import com.rendog.client.gui.rgui.component.Button
import com.rendog.client.gui.rgui.component.SettingSlider
import com.rendog.client.gui.rgui.component.Slider
...
object ColorPicker : TitledWindow("Color Picker", 0.0f, 0.0f, 200.0f, 200.0f, SettingGroup.NONE) {
    ...
    private var hoveredChild: Slider? = null
        set(value) {
            ...
            field?.onLeave(AbstractRendogGui.getRealMousePos())
            value?.onHover(AbstractRendogGui.getRealMousePos())
            field = value
        }
