...
import com.rendog.client.gui.rgui.InteractiveComponent
...
import com.rendog.client.commons.extension.ceilToInt
import com.rendog.client.commons.extension.floorToInt
import com.rendog.client.commons.extension.sumByFloat
...
open class ListWindow(
    ...
    var hoveredChild: Component? = null
        private set(value) {
            ...
            (field as? InteractiveComponent)?.onLeave(AbstractRendogGui.getRealMousePos())
            (value as? InteractiveComponent)?.onHover(AbstractRendogGui.getRealMousePos())
            field = value
        }
