...
## 주의 사항
> 본 클라이언트/모드의 제작자는 Mell_Da(MellDa1024)로, 렌독서버의 관리자들은 RendogClient와 관계가 없음을 밝힙니다.  
> RendogClient의 로고는 렌독서버의 로고에서 가지고 왔습니다.  
> 그렇기에 본 프로젝트의 관리자 Mell_Da 본인은 이 로고에 대해서 일체의 소유권을 가지고 있지 않으며, 저작권 클래임이 들어올 시 즉각 삭제 혹은 기존 사진 파일을 대체하도록 하겠습니다.